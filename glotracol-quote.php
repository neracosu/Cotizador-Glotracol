...
define( 'GLOTRACOL_QUOTE_VERSION', '2.16.1' );
...
require_once GLOTRACOL_QUOTE_PATH . 'includes/class-import-diff.php';
...
require_once GLOTRACOL_QUOTE_PATH . 'includes/class-frontend-dashboard.php';
